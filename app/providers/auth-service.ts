...
//         let body = JSON.stringify({ username: username, password: password }); //JSON.stringify(user);
//         return this._http
//             .post(apiUrl, body)
...
// login(username: String, password: String) {
//         let myToken = Cookie.getCookie('token');
//         console.log(myToken);
//         let body = JSON.stringify({ username: username, password: password }); //JSON.stringify(user);
...
//                 var data = res.json();
//                 console.log(data);
//                 Cookie.setCookie('token', data.token, 10 /*days from now*/);
//                 return data;
//             });
//     }
